...
Fonctionnalité: Le Consommateur réinitialise son mot de passe 

  *En tant que Consommateur,  
  je veux pouvoir réinitialiser mon mot de passe  
  lorsque je l'ai oublié.*  

  Plan du Scénario: Le Consommateur fait une demande de réinitialisation de mot de passe 

    Ceci correspond à l'utilisation normale de la fonctionnalité: un Consommateur enregistré 
  ...
  @not-e2e
  Plan du Scénario: Le Consommateur définit un mot de passe conforme dans les temps
    ...
    Etant donné un <utilisateur> qui consulte son lien de réinitialisation de mot de passe dans les temps
  ...
  @not-e2e
  Plan du Scénario: Le Consommateur définit son mot de passe une deuxième fois avec le même lien
    ...
    @not-e2e
    Plan du Scénario: Le Consommateur définit son mot de passe trop tard 
